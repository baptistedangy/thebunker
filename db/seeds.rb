...
bunker = Bunker.new( name: "The Basic Bunker", address: "Paris", price: 20, capacity: 4, description: "Good for kids", user: U1 )
...
bunker = Bunker.new( name: "The Luxuary Bunker", address: "London", price: 300, capacity: 10, description: "For isolated pool parties", user: U1 )
...
bunker = Bunker.new( name: "The Wine Bunker", address: "Bodeaux", price: 100, capacity: 2, description: "Joyful Survivalism", user: U2 )
...
bunker = Bunker.new( name: "The Woods Bunker", address: "Sofia", price: 40, capacity: 4, description: "Better be hidden", user: U2 )
...
bunker = Bunker.new( name: "The Selfish Bunker", address: "Berlin", price: 300, capacity: 4, description: "Fuck The Others", user: U3 )
...
bunker = Bunker.new( name: "The Warrior Bunker", address: "Houston", price: 200, capacity: 3, description: "Always be prepared", user: U3 )
